...
class CriteoDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, dataset_path=None, cache_path='.criteo', rebuild_cache=False, min_threshold=10):
        ...
        self.prefix = "/home/fywang/project/remote_pro/PNNConvModel/data/criteo/"

        # self.prefix = "./data/criteo/"
        # self.prefix = "/home/fywang/project/remote_pro/PNNConvModel/data/"
    ...
    def __read_train_all_feats(self):
        ...
        return pickle.load(open("train_all_811.pkl", "rb"))
...
def get_criteo_dataset_train(train_path="train.txt", batch_size=2048):
    # the test_path maybe null, if it is, we need to split the train dataset
    ...
    train_dataset = CriteoDataset(dataset_path=train_path, cache_path="/home/fywang/project/remote_pro/PNNConvModel/dataset/"+".criteo_811", rebuild_cache=False)
    field_dims = train_dataset.field_dims
...
if __name__ == '__main__':
    ...
    field_dims, train_loader, valid_loader, test_loader = get_criteo_dataset_train(train_path2, batch_size=2048)
    print(field_dims)
    #
