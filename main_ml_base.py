...
from dataset.frappe.MyloadDataMl import getdataloader_ml
...
def get_model(
    ...
    if name == "nfm":
        ...
        return GFRLFM(field_dims, embed_dim, type="glu",field_len=3)
    ...
    for K in [256]:  # latent factors
        ...
        with open(paths + f"/{model_name}logs2_{time_fix}.p", "a+") as fout:
            ...
            for epoch_i in range(epoch):
                ...
                print("ml-tag", model_name, K, epoch_i, weight_decay, learning_rate)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name', default='ml_log')
    ...
    parser.add_argument('--save_dir', default='chkpt_ml')
